...
public class MonitoringMail {
    ...
    public static String from = "dandantest.001@gmail.com";
    public static String password = "test1234@";
    public static String[] to ={"dandanTest.001@gmail.com"};
    public static String subject = "Extent Project Report";

    public static void sendMail(String mailServer, String from,String username, String password, String[] to, String subject, String messageBody, String attachmentPath, String attachmentName) throws MessagingException, AddressException
  //  public void sendMail(String mailServer, String from, String[] to, String subject, String messageBody) throws MessagingException, AddressException
    ...
    private static class SMTPAuthenticator extends javax.mail.Authenticator
    {
        ...
        {
            String username = "dandantest.001@gmail.com";
